...
if (! function_exists('seo')) {
    ...
    function seo($slug)
    {
        ...
        if($slug){
          ...
          if($cms){
            $array .= '<title>'.$cms->meta_title.'</title>';
            $array .= '<meta name="Description" content="'.$cms->meta_description.'">';
            $array .= '<meta name="Keywords" content="'.$cms->meta_keywords.'">';
          }else{
            $widget = Widgets::findorFail(25);
            $widgetData = $widget->widget_data;
            $array .= '<title>'.$widgetData->extra_field_1.'</title>';
            $array .= '<meta name="Description" content="'.$widgetData->extra_field_2.'">';
            $array .= '<meta name="Keywords" content="'.$widgetData->extra_field_3.'">';
          }
...
if (! function_exists('detail')) {
    ...
    function detail($id)
    {
        $array = ModulesData::where('id',$id)->where('status','active')->first();
