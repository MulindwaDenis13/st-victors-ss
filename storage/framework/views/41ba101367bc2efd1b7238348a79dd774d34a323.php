...
<div class="row">
  ...
  <div class="col-md-12">
     <div class="form-group">
        ...
        <?php echo Form::textarea('description', null, array('class'=>'form-control', 'id'=>'description', 'placeholder'=>$wid->title.' Description', 'required'=>'required')); ?>
...
<?php /**PATH /Users/pcu/Desktop/Projects/avon_files/resources/views/admin/widgets_data/inc/form.blade.php ENDPATH**/ ?>