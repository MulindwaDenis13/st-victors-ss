...
class CreateWidgetsDataTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('widgets_data', function (Blueprint $table) {
            ...
            $table->longText('extra_field_4')->nullable();
            $table->longText('extra_field_5')->nullable();
            $table->longText('extra_field_6')->nullable();
            $table->longText('extra_field_7')->nullable();
            $table->longText('extra_image_1')->nullable();
            $table->longText('extra_image_2')->nullable();
